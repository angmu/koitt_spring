...
<%-- </c:if> --%>
	<div id="container">
		...
		<div id="outbox">		
			...
			<!-- contents -->
			<form id="contents" action="step03" name="join01" method="post">
				<div id="member">
					...
					<div class="agreeWrap">
						...
						<p>본 약관은 2005년 5월 16일부터 시행합니다.</p>
							...
							<ul>
								<li class="chk">
									<input type="checkbox" id="agree1" name="agree1" /><label for="agree1">이용약관에 동의합니다.</label>
								</li>
								<li class="btn">
						...
						<h4>3. 개인정보의 보유 및 이용기간</h4>
							...
							<ul>
								<li class="chk">
									<input type="checkbox" id="agree2" name="agree2"/><label for="agree2">개인정보 보호를 위한 이용자 <span>동의사항에 동의합니다.</span></label>
								</li>
								<li class="btn">
									<a href="#" class="nbtnMini">전체보기</a>
								</li>
						...
						<h4>3. 개인정보의 보유 및 이용기간</h4>
							...
							<ul class="fn">
								<li class="chk">
									<input type="checkbox" id="agree3" name="agree3"/><label for="agree3">개인정보 보호를 위한 이용자 <span>동의사항에 동의합니다.</span></label>
								</li>
								<li class="btn">
									<a href="#" class="nbtnMini">전체보기</a>
								</li>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								...
								<li><input type="button" onclick="promise_ch()" style="border: none;cursor: pointer;" class="sbtnMini" value="가입하기"></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
