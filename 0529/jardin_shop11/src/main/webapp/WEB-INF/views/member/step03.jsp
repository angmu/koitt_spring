		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					...
					<form class="memberbd" name="join" action="joinok">
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="text" class="w134" name="id" readonly="readonly"/></li>
											<li><a href="#" class="nbtnMini idch">중복확인</a></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li><span class="mvalign">※ 영문 / 숫자 혼용 특수기호(!@#$%^*_)만 사용가능으로 8~20자 까지 가능.</span></li>
										</ul>
									</td>
								</tr>
								<tr>
								...
								<tr>
                                    ...
                                    onchange="document.join.email2.focus();
                              document.join.email2.value =document.join.emailList[document.join.emailList.selectedIndex].value;
                            " id="emailOne">
								...
								<tr>
									...
									<td>
										...
										<ul class="question">
											<li>
												<input type="radio" name="email_check" id="receive_yes" class="radio_t" checked="checked" value="1"/><label for="receive_yes">예</label>
											</li>
											<li>
												<input type="radio" name="email_check" id="receive_no" class="radio_t" value="0"/><label for="receive_no">아니오</label>
											</li>
										</ul>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li>
												<input type="text" class="w134" name="address1" readonly="readonly" />&nbsp;
											</li>
											<li><a href="javascript" onclick="post()" class="addressBtn"><span>우편번호 찾기</span></a></li>
											<li class="pt5"><input type="text" class="addressType" name="address2" readonly="readonly"/></li>
									...
									<td>
										<ul class="pta">
											...
											<li class="pt5">
												<ul class="baseQues">
													<li>
														<input type="radio" name="sms" id="sms_yes" class="radio_t" checked="checked" value="1"/><label for="sms_yes">예</label>
													</li>
													<li>
														<input type="radio" name="sms" id="sms_no" class="radio_t" value="0"/><label for="sms_no">아니오</label>
													</li>
												</ul>
											</li>
										</ul>
									...
									<td>
										<ul class="pta">
											...
											<li class="pt5">
												<ul class="baseQues">
													<li>
														<input type="radio" name="calender_check" id="solar" class="radio_t" checked="checked" value="1"/><label for="solar">양력</label>
													</li>
													<li>
														<input type="radio" name="calender_check" id="lunar" class="radio_t" value="2"/><label for="lunar">음력</label>
													</li>
												</ul>
											</li>
										</ul>
							...
							<div class="btnArea">
								<div class="bCenter">
									<ul>
										<li><a href="${pageContext.request.contextPath}/main" class="nbtnbig">취소하기</a></li>
										<li><input type="button" onclick="join_ch()" style="border: none;cursor: pointer;" class="sbtnMini" value="가입하기"></li>
									</ul>
								</div>
							</div>
							<!-- //Btn Area -->
...
function join_ch(){
	//id ch
	var id_ch=/^[a-z]+[a-z0-9_]{4,16}$/g;
	//pw ch
	var pw_ch=/^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,20}$/;
