				...
				<ul>
					<c:choose>
						<c:when test="${loginInfo!=null }">
							<li><a href="${pageContext.request.contextPath}/member/logout" id="logat">LOGOUT</a></li>
							<li><a href="#">MY PAGE</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="${pageContext.request.contextPath}/member/login_view">LOGIN</a></li>
							<li><a href="${pageContext.request.contextPath}/member/join_view">JOIN</a></li>
						</c:otherwise>
					</c:choose>
					<li><a href="#">CART</a></li>
				</ul>
