		...
		<section>
			<div id="content">
				<div>
					...
					<!--  버튼 -->
					<div>
						<a href="reply_view?bId=${content_view.bId }" role="button">답글달기</a>
						<a href="modify_view?bId=${content_view.bId }" role="button">수정</a>
						<a href="delete?bId=${content_view.bId }" role="button">삭제</a>
