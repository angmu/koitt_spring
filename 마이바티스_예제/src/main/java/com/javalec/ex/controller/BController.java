...
public class BController {
	...
	public String reply(BDto bDto,Model model) {
		...
		dao.reply(bDto.getbName(), bDto.getbTitle(), bDto.getbContent(),bDto.getbGroup(),bDto.getbStep(),bDto.getbIndent());
		return "redirect:list";
	}
	
	@RequestMapping("login")
	public String login(BDto bDto,Model model) {
		
		return "login";
	}
	
	@RequestMapping("loginCheck")
	public String loginCheck(BDto bDto,Model model,HttpSession session) {
		IDao dao = sqlSession.getMapper(IDao.class);
