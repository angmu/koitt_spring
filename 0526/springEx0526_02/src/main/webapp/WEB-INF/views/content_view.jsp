				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							<div class="subject">
								<ul>
									<li>${content_view.bTitle }</li>
								</ul>
							</div>
							<div class="day">
								<p class="txt">작성일<span><fmt:formatDate value="${content_view.bDate }" pattern="yy.MM.dd"/></span></p>
							</div>
						</div>
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								<li><a href="list.do" class="sbtnMini mw">목록</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
