							...
							<tbody>
								<c:forEach var="dtos" items="${list }">
									<tr>
										...
										<fmt:formatDate value="${dtos.bDate }" pattern="yyyy-MM-dd" var="write_dt"/>
										<td class="tnone">1</td>
										<td class="left">
											<a href="content_view.do?bId=${dtos.bId }">
										...
										<td><fmt:formatDate value="${dtos.bDate }" pattern="yy-MM-dd"/></td>
										<td class="tnone right">${dtos.bHit }</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
