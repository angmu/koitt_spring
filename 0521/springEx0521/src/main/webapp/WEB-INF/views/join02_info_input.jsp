...
<html>
	...
	<body>
		...
		<section>
			<form name="agree" method="get" action="join03_success">
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_address_dl">
						...
						<dd>
							<input type="text" id="f_postal" name="address1" required />
							<input type="button" value="우편번호"/>
							<input type="text" id="address1" name="address2" required />
							<input type="text" id="address2" name="address3" required />
						</dd>
